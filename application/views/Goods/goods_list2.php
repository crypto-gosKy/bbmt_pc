 ...
 ?>
		...
		<div class="fixed_container">
			...
			<ul class="w-100 mt-35 navBox pos-r" id="channelWrap">
				...
				<li class="navItem senior-store checked"" data-type="1"><a href="<?php echo site_url('goods/foreign_goods_list'); ?>">保税区直供</a></li>
		...
		<div class="fixed-container">
			<div id="searchCon" class="d-n" style="display: block;">
				<div class="pt-10 cor-grey6 fs-14 search-crumbs" id="searchCrumbs"> <span class="con-block d-ib ml-10 cate-crumbs" data-id="257"> <span></span><i class="iconfont ml-5 delete-icon"></i> </span> <i class="iconfont ml-10"></i> <span class="con-block d-ib ml-10 subcate-crumbs" data-id="262"><span></span><i class="iconfont ml-5 delete-icon"></i> </span>					<i class="iconfont ml-10"></i> <span class="con-block d-ib ml-10 brand-crumbs" data-type="brand" data-for="brand668"> <span></span><i class="iconfont ml-5 delete-icon"></i> </span> </div>
					...
					<ul>
						...
						<li id="secondCateLi" class="d-n" style="display:none;">
							...
							<div class="cate-block" style="height: 31px;">
								<div class="inner-cate"><a class="d-ib subcate-a" data-type="subcate" data-id="262" id="subcate262"><span></span><i class="iconfont ml-5"></i></a><a class="d-ib subcate-a" data-type="subcate" data-id="261" id="subcate261"><span></span></a><a class="d-ib subcate-a" data-type="subcate"
										data-id="259" id="subcate259"><span></span></a><a class="d-ib subcate-a" data-type="subcate" data-id="258" id="subcate258"></a></div>
							</div>
						</li>
						<li id="brandLi" class="d-n last" style="display:none;">
							...
							<span class="cate-more" style="display: none;">更多<span class="iconfont"></span></span>
							<div class="cate-block">
								<div class="inner-cate"><a class="d-ib brand-a " data-type="brand" data-id="668" id="brand668"><span></span><i class="iconfont ml-5"></i></a><a class="d-ib brand-a" data-type="brand" data-id="656" id="brand656"><span></span></a></div>
							</div>
						</li>
					</ul>
				</div>
		...
		<script type="text/javascript" src="../../../asset/js/goods_list/goods_list2.js" ></script>
